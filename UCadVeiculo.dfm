  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMCadVeiculo.dsVeiculo
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'ID Propriet'#225'rio'
            Visible = True
          end
          item
            Expanded = False
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object Label14: TLabel
          ...
          Width = 136
          Height = 13
          Caption = '(Peso do ve'#237'culo sem carga)'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clGreen
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
        ...
        object RxDBLookupCombo1: TRxDBLookupCombo
          ...
          LookupField = 'UF'
          LookupDisplay = 'UF'
          LookupSource = DMCadVeiculo.dsUF
          TabOrder = 3
        end
        ...
        object RxDBLookupCombo2: TRxDBLookupCombo
          ...
          Height = 21
          DropDownCount = 8
          DataField = 'ID_PROPRIETARIO'
          DataSource = DMCadVeiculo.dsVeiculo
          ListStyle = lsDelimited
          LookupField = 'ID'
          LookupDisplay = 'NOME;CNPJ_CPF'
          LookupSource = DMCadVeiculo.dsProprietario_Vei
          TabOrder = 8
        end
