object frmCadProprietario: TfrmCadProprietario
  Left = 313
  Top = 188
  Width = 763
  Height = 462
  BorderIcons = [biSystemMenu, biMaximize]
  Caption = 'Cadastro de Propriet'#225'rio de Ve'#237'culo'
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMCadProprietario.dsProprietario_Vei
        ...
        Columns = <
          ...
          item
            ...
            FieldName = 'TIPO_REG'
            Title.Alignment = taCenter
            Title.Caption = 'Tipo Propriet'#225'rio'
            Width = 87
            Visible = True
          end
          item
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object RxDBLookupCombo3: TRxDBLookupCombo
          ...
          LookupField = 'UF'
          LookupDisplay = 'UF'
          LookupSource = DMCadProprietario.dsUF
          TabOrder = 4
        end
      end
    end
